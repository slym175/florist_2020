...
global $product;?>
    <div class="col-lg-2 col-md-3 col-6 card p-0 product">
        <a href="<?= the_permalink() ?>">
            <img class="card-img-top" src="<?= get_the_post_thumbnail_url(get_the_ID(), array(196, 196)) ?>" alt="Card image cap">
        </a>
...
<?php if($prod->max_num_pages > $data['page']) :?>
    <div class="col-12 text-center">
        <a data-url="<?= admin_url('admin-ajax.php') ?>" data-page="<?= $data['page']+1 ?>" data-limit="<?= $limit ?>" data-slugg="<?= $data['slugg'] ?>" href="javascript:void(0)" onclick="loadProductsInCategory(this, false);" title="<?= $slugg ?>" class="btn-more px-4 py-2 mt-md-4 mt-2">
